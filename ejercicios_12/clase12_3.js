...
let contadorImpares = 0; //variable para contar los números impares.

for (let i = 0; i < numerosIngresados; i++) {
    if (i % 2 !== 0) {
        
        contadorImpares++; //incrementar contador si es impar
   }
}

console.log(`La cantidad de números impares desde 0 hasta ${numerosIngresados} (inclusive) es: ${contadorImpares}`)
